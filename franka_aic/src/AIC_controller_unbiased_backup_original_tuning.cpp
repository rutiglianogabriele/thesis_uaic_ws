 ...
 *
 * Unbiased AIC Task Space - Original Tuning
 */
...
namespace franka_aic
{
  ...
  void AICController::starting(const ros::Time & /*time*/)
  {
    ...
    SigmaP_yq0(0, 0) = 0.1 * 1 / var_q;    // gru_seen
    SigmaP_yq1(0, 0) = 0.1 * 1 / var_qdot; // gru_seen

    SigmaP_yq0(2, 2) = 0.1 * 1 / var_q;    // gru_seen
    SigmaP_yq1(2, 2) = 0.1 * 1 / var_qdot; // gru_seen
